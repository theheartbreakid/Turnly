...
fun SdfShader(imageBitmap: ImageBitmap): SdfShader {
    return object : SdfShader {
        ...
        override fun BackdropEffectScope.apply(
            ...
            // Implementation depends on runtimeShaderEffect which I haven't fully implemented here
        }
    }
}
